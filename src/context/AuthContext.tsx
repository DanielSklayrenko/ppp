...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const changePassword = async (currentPassword: string, newPassword: string): Promise<{ success: boolean; error?: string }> => {
    try {
      ...
      const isCurrentValid = bcrypt.compareSync(currentPassword, storedUser.passwordHash);
      if (!isCurrentValid) {
  ...
  return (
    <AuthContext.Provider value={{ user, isAuthenticated: !!user, isLoading, login, register, logout, updateUser, resetPassword, changePassword }}>
      {children}
