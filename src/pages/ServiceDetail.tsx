    ...
    return (
      <div className="min-h-screen bg-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 text-center">
          ...
          <Link to="/services" className="text-purple-400 hover:text-purple-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Image */}
            <div className="aspect-video bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl overflow-hidden flex items-center justify-center text-8xl">
              {category?.icon || '📦'}
            </div>
            ...
            <div>
              <div className="flex items-center space-x-2 text-sm text-gray-400 mb-3">
                ...
                <span>/</span>
                <Link to={`/services?category=${service.category}`} className="hover:text-purple-400">
                  {category?.name}
                </Link>
                {service.subcategory && (
                  <>
          ...
          <div className="space-y-6">
            ...
            {/* Pricing Card */}
            <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 backdrop-blur-lg border border-purple-500/30 rounded-2xl p-6 sticky top-24">
              <div className="mb-6">
              ...
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-purple-500/25 hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
              >
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button
                  onClick={handleOrder}
                  disabled={isOrdering}
                  className="flex-1 py-3 px-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl hover:shadow-lg transition-all disabled:opacity-50"
                >
