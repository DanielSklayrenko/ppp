      ...
      <div className="w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Присоединяйтесь к нашей платформе</p>
          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="text-xs opacity-70 mt-1">Ищу исполнителя</div>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <div className="text-xs opacity-70 mt-1">Ищу работу</div>
                </button>
              </div>
            </div>
