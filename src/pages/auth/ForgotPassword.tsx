          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-6">
                На ваш email отправлен временный пароль. Для демонстрации он также показан ниже:
              </p>
              {tempPassword && (
                <div className="bg-white/10 rounded-lg p-4 mb-6">
                  <p className="text-sm text-gray-400 mb-2">Временный пароль:</p>
                  <p className="text-2xl font-mono text-purple-400">{tempPassword}</p>
                </div>
              )}
              <Link
                to="/login"
                className="inline-block py-3 px-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all"
              >
      ...
      <div className="w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Введите ваш email для сброса пароля</p>
          </div>
